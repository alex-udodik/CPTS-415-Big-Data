...
def parseArt(): #broken?????
    with open('art.csv', mode='r') as file:
        csvFile = csv.reader(file)
        ...
        for lines in csvFile:
            if count == 0:
                ...
                lineNumber = lineNumber + 1
                continue
            str1 = "INSERT INTO Art (name,genuiune,category,buy,sell,color1,color2,size,realartworktitle,artist" \
...
def parseBottoms():
    with open('bottoms.csv', mode='r') as file:
        csvFile = csv.reader(file)
...
def parseDressUp():
    with open('dress-up.csv', mode='r') as file:
        csvFile = csv.reader(file)
...
def parseFencing():
    with open('fencing.csv', mode='r') as file:
        csvFile = csv.reader(file)
...
def parseFloors():
    with open('floors.csv', mode='r') as file:
        csvFile = csv.reader(file)
...
def parseFossils():
    with open('fossils.csv', mode='r') as file:
        csvFile = csv.reader(file)
...
def parseHeadwear():
    with open('headwear.csv', mode='r') as file:
        csvFile = csv.reader(file)
...
def parseHousewares():
    with open('housewares.csv', mode='r') as file:
        csvFile = csv.reader(file)
...
def parseInsects():
    with open('insects.csv', mode='r') as file:
        csvFile = csv.reader(file)
...
def parseMiscellaneous():
    with open('miscellaneous.csv', mode='r') as file:
        csvFile = csv.reader(file)
    ...
    with open('music.csv', mode='r') as file:
        ...
        for lines in csvFile:
            if count == 0:
                ...
                lineNumber = lineNumber + 1
                continue
            str1 = "INSERT INTO Music (Name,Variation,BodyTitle,Pattern" \
                   ",PatternTitle,DIY,BodyCustomize,PatternCustomize,KitCost,Buy" \
                   ",Sell,Color1,Color2,Size,Source,SourceNotes,Version,HHAConcept1,HHAConcept2,HHASeries,HHASet" \
                   ",Interact,Tag,Outdoor,SpeakerType,LightingType,Filename,VariantID,InternalID" \
                   ",UniqueEntryID)" \
